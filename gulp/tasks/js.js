...
const jsMin = config.src.js + 'min/*.js';
...
function js() {
	return src( [ config.src.js + '**/*.js', '!' + jsMin ] )
...
function jsWatch() {
	return watch( [ config.src.js + '*', '!' + jsMin ], series( js ) );
}
...
function jsLintWatch() {
	return watch( [ config.src.js + '*', '!' + jsMin ], series( jsLint ) );
}
